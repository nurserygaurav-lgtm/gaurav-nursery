import { BarChart3, Boxes, Gauge, IndianRupee, MessageSquareText, PackagePlus, PackageSearch, Settings, ShoppingBag, Star, UploadCloud, Users } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Bulk Upload', to: '/seller/products/bulk-upload', icon: UploadCloud },
