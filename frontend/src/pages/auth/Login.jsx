...
export default function Login() {
  ...
  return (
    <section className="premium-container py-10">
      <div className="grid items-stretch overflow-hidden rounded-[2rem] bg-white shadow-card lg:min-h-[620px] lg:grid-cols-[0.95fr_1.05fr]">
        <div className="flex min-w-0 flex-col justify-center p-6 sm:p-10">
          ...
          <h1 className="text-3xl font-black tracking-tight text-leaf-950 sm:text-4xl">Welcome back</h1>
        ...
        <div className="relative min-h-[360px] overflow-hidden bg-gradient-to-br from-leaf-900 via-leaf-700 to-leaf-500 p-8 text-white lg:min-h-[620px]">
          <img
          ...
          <div className="relative z-10 flex h-full min-h-[300px] flex-col justify-end">
            ...
            <h2 className="mt-3 max-w-md text-3xl font-black tracking-tight sm:text-4xl">Grow a greener home with every order.</h2>
          </div>
        </div>
      </div>
    </section>
