...
export default function SellerOrders() {
  ...
  return (
    <section>
      <h1 className="text-3xl font-black text-leaf-900">Seller Orders</h1>
      <p className="mt-2 text-sm text-stone-600">View incoming orders and move them through processing, shipping, and delivery.</p>
      ...
      {!isLoading && !error && !orders.length && (
        <div className="mt-6 rounded-lg bg-white p-6 shadow-soft">
          <p className="text-stone-600">No seller orders yet.</p>
        </div>
      )}
      {!isLoading && !error && !!orders.length && (
